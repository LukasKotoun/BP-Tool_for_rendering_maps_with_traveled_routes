...
OSM_TMP_FOLDER = '/zfs-pool/home/xkotou08/BP/extracted_cz'
...
AREAS_STYLE_ZOOM_LEVEL = 7
WAYS_STYLE_ZOOM_LEVEL = 7
NODES_STYLE_ZOOM_LEVEL = 7
...
try:
    font_paths = fm.findSystemFonts(fontpaths='./common/fonts/texts', fontext='ttf')
