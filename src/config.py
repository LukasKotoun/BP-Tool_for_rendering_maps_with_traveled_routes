...
OSM_INPUT_FILE_NAMES: str | list[str] = ['../osm_files/brnoPrevTest.osm.pbf']
...
OUTPUT_PDF_NAME: str = '../pdfs/brnoPrev' # in server send and than delete, and name will be generated by uuid
...
OUTER_AREA: WantedArea =  [{"area": "Česko", "plot": False, "category": 2, "width": 1}]
...
wanted_areas: WantedCategories = {
    ...
    'leisure': {'park', 'garden',
                # 'pitch', 'golf_course', 'playground','sports_centre',
