...
GPX_STYLES_VALIDATION = {"data": (str, False, None), "general_data": (
    str, False, None), "style": (dict, False, None)}
...
GPX_STYLES_MAPPING = {
    ...
    "zindex": Style.ZINDEX.value,
    "edge_alpha": Style.EDGE_ALPHA.value,
    "edge_color": Style.EDGE_COLOR.value,
    "edge_width_ratio": Style.EDGE_WIDTH_RATIO.value,
    "edge_linestyle": Style.EDGE_LINESTYLE.value,
    "edge_capstyle": Style.EDGE_CAPSTYLE.value,
    "linestyle": Style.LINESTYLE.value,
    "line_capstyle": Style.LINE_CAPSTYLE.value,
    "gpx_above_text": Style.GPX_ABOVE_TEXT.value,
    "start_marker": Style.START_MARKER.value,
    "start_marker_width": Style.START_MARKER_WIDTH.value,
    "start_marker_edge_ratio": Style.START_MARKER_EDGE_RATIO.value,
    "start_marker_color": Style.START_MARKER_COLOR.value,
    "start_marker_edge_color": Style.START_MARKER_EDGE_COLOR.value,
    "start_marker_alpha": Style.START_MARKER_ALPHA.value,
    "finish_marker": Style.FINISH_MARKER.value,
    "finish_marker_width": Style.FINISH_MARKER_WIDTH.value,
    "finish_marker_edge_ratio": Style.FINISH_MARKER_EDGE_RATIO.value,
    "finish_marker_color": Style.FINISH_MARKER_COLOR.value,
    "finish_marker_edge_color": Style.FINISH_MARKER_EDGE_COLOR.value,
    "finish_marker_alpha": Style.FINISH_MARKER_ALPHA.value,
    "marker_layer_position": Style.MARKER_LAYER_POSITION.value
}
