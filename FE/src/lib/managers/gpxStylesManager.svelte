            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6 bg-gray-50 p-4 rounded">
                    ...
                    <input
                        ...
                        class="w-5 h-5 items-center rounded-lg"
                        on:change="{() => $gpxStyles.group[groupName].edge_color = $gpxStyles.group[groupName].edge_color ? null : defaultColor}"
                    />
                </div>
                    <div class="flex items-center space-x-4">
                        <p class="w-1/3">Barva:</p>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <input 
                            ...
                            class="w-full"
                        />
                        <span>{$gpxStyles.group[groupName].edge_width_ratio.toFixed(1)}</span>
                    </div>
                    ...
                    <div class="space-y-6 border-t pt-4 mt-4">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <input 
                                ...
                                class="w-full"
                            />
                            <span>{$gpxStyles.group[groupName].start_marker_alpha.toFixed(1)}</span>
                        </div>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <input 
                                type="color" 
                                bind:value={$gpxStyles.group[groupName].start_marker_edge_color} 
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            class="w-full"
                        />
                        <span>{$gpxStyles.group[groupName].start_marker_edge_ratio.toFixed(1)}</span>
                        </div>
                    </div>
                    ...
                    <div class="border-t space-y-6 pt-4 mt-4">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <input 
                                ...
                                class="w-full"
                            />
                            <span>{$gpxStyles.group[groupName].finish_marker_alpha.toFixed(1)}</span>
                        </div>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <input 
                                type="color" 
                                bind:value={$gpxStyles.group[groupName].finish_marker_edge_color} 
                                class="w-full h-10"
                            />
                        </div>
                        ...
                        class="w-full"
                    />
                    <span>{$gpxStyles.group[groupName].finish_marker_edge_ratio.toFixed(1)}</span>
